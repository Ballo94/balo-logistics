  ...
  return (
    <main className="min-h-screen overflow-x-hidden bg-[#f5f7fa] text-slate-950">
      <section className="relative isolate min-h-[54rem] overflow-hidden bg-[#1676b5] text-white sm:min-h-[56rem] lg:min-h-[52rem]">
        ...
        <div id="home" className="relative z-10 mx-auto grid max-w-7xl gap-12 px-4 pb-8 pt-20 sm:px-6 sm:pb-10 sm:pt-24 lg:grid-cols-[1.1fr_.9fr] lg:items-center lg:px-8 lg:pb-28 lg:pt-32">
...
function Metric({ value, label }: { value: string; label: string }) { return <div className="min-w-0 px-2 py-4 text-center sm:px-4 sm:py-5 lg:px-5"><p className="text-[clamp(.95rem,4.5vw,1.25rem)] font-black leading-tight tracking-tight text-yellow-300 sm:text-xl lg:text-2xl xl:text-3xl">{value}</p><p className="mt-1 text-[0.6rem] font-bold uppercase tracking-wider text-blue-200 sm:text-[0.65rem]">{label}</p></div>; }
...
function ServicesBackdrop() { return <svg aria-hidden="true" viewBox="0 0 1400 600" preserveAspectRatio="xMidYMid slice" className="pointer-events-none absolute inset-0 h-full w-full opacity-[0.04]"><g fill="none" stroke="#0b4f83" strokeWidth="2"><path d="M72 310c88-115 204-155 342-128 97 18 151 88 264 77 136-13 198-139 363-116 105 14 201 82 288 173"/><path d="M134 405c147-66 248-45 351 31 102 75 209 80 326 15 122-68 241-73 417-10" strokeDasharray="11 13"/><ellipse cx="700" cy="300" rx="520" ry="220"/><path d="M180 300h1040M250 205h900M250 395h900M700 80c-158 120-158 320 0 440M700 80c158 120 158 320 0 440"/></g><g fill="#0b4f83"><circle cx="170" cy="360" r="8"/><circle cx="445" cy="225" r="8"/><circle cx="735" cy="430" r="8"/><circle cx="1020" cy="190" r="8"/><circle cx="1260" cy="355" r="8"/></g></svg>; }
...
function HeroSlideshow() {
  ...
  return <div className="absolute inset-0" aria-roledescription="carousel" aria-label="Balo Logistics operations">
    ...
    <div className="absolute right-4 top-24 z-20 flex flex-col items-end gap-3 sm:right-6 sm:top-28 lg:bottom-24 lg:right-8 lg:top-auto">
